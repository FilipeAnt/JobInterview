...
public class QuestionDB {
    ...
    public static final String[] QUESTIONS_DATA_BASE = new String[]{"Which of these is a pillar of OOP: #None #Retraction #Inflection #Reflection #None ",
            ...
            "It takes 10 men and 8 hours to build a wall, how much time does it take with 5 men? #4 hours #None, because the wall was built already #20 hours #2 hours #None, because the wall was built already ",
            "How restrictive is default compared to public, protected or private accessibility? #Less restrictive than public #More restrictive than private #No restrictions #More restrictive than protected, less than private #More restrictive than protected, less than private ",
            ...
            "What are the four pillars of OOP? #Inheritance, Abstraction, Composition, Polymorphism #Abstraction, Polyphormism, Encapsulation, Heritance #Abstraction, Polymorphism , Encapsulation, Inheritance #Objects, Methods, Properties, Main #Abstraction, Polymorphism , Encapsulation, Inheritance ",
